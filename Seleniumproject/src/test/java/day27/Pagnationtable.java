...
WebDriverManager.chromedriver().setup();
		...
		String text=driver.findElement(By.xpath("//div[@class='col-sm-6 text-end']")).getText();  //Showing 1 to 10 of 15518 (1552 Pages)
		
		//text.substring(26, 29); //1552 but this it not applicable hrad coded
			
		int total_pages=Integer.parseInt(text.substring(text.indexOf("(")+1,text.indexOf("Pages")-1)); // this is concept even value is change of pages in table 
